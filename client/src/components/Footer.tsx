...
const loanLinks = [
  { label: "Fix & Flip Loans", href: "#loan-programs" },
  { label: "DSCR Loans", href: "#loan-programs" },
  { label: "Bridge Loans", href: "#loan-programs" },
  { label: "New Construction", href: "#loan-programs" },
  { label: "Multi-Family", href: "#loan-programs" },
  { label: "Cash-Out Refinance", href: "#loan-programs" },
];
...
const companyLinks = [
  ...
  { label: "Become a Broker", href: "#contact" },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
              ...
              {loanLinks.map((link) => (
                <li key={link.label}>
                  <button
                    ...
                    className="text-white/40 hover:text-[#E8A020] text-xs transition-colors text-left"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <button
              ...
              className="text-[#E8A020] text-xs mt-3 hover:text-[#F0B840] transition-colors"
            >
              View Full Map →
            </button>
          </div>
